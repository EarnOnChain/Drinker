...
class BlockchainManager:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.info(f"Blockchain manager initialized. Address: {self.my_address}")
    ...
    def get_allowance(self, owner: str, spender: str = None) -> Optional[float]:
        ...
        try:
            ...
            logger.error(f"Error getting allowance from {owner} to {spender}: {e}")
            return None
    ...
    def get_gas_price(self) -> int:
        ...
        try:
            ...
            logger.warning(f"Failed to get current gas price: {e}. Using default.")
        ...
        try:
            ...
            while time.time() - start_time < timeout:
                try:
                    ...
                    logger.info(f"Transaction {tx_hash.hex()} confirmed with status: {receipt.status}")
                    return receipt
